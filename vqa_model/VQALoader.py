...
class VQALoader(Dataset):
    def __init__(self, imgFolder, images_file, questions_file, answers_file, encoder_questions, encoder_answers, model_type, train=True, ratio_images_to_use = 1, transform=None, patch_size=512):
        ...
        if self.model_type == 'VQAGAP_qbert_Model' or self.model_type == 'VQAGAP_qbert_Model_finetune' or self.model_type == 'VQAGAP_bert_Model' or self.model_type == 'VQAGAP_bert_Model_finetune' or self.model_type == 'VQAGAP_qbert_dca_Model' or self.model_type == 'VQAGAP_qbert_dca_Model_finetune':
